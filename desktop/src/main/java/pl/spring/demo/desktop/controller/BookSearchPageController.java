...
public class BookSearchPageController {
	...
	@FXML TableView<BookTo> tableBook;
	@FXML TextField titleField;
	@FXML TextField nameField;
	@FXML TextField lastNameField;
	@FXML TableColumn<BookTo, String> titleColumn;
	@FXML TableColumn<BookTo, String> nameColumn;
	@FXML TableColumn <BookTo, String> lastNameColumn;
	@FXML Button addAuthor;
	...
	private void initialize() {
		...
		searchButton.disableProperty().bind(
			    ...
			    .and(Bindings.isEmpty(nameField.textProperty()))
	...
	private void initializeResultTable() {
		...
		nameColumn.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(cellData.getValue().getAuthors().iterator().next().getFirstName()));
		lastNameColumn.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(cellData.getValue().getAuthors().iterator().next().getLastName()));
	...
	@FXML public void addAuthor(ActionEvent event) throws IOException {
